...
TreeGraphFileName = "DrinkgingWater_NTU_Graph.dot"
ExportedTreeFileName = "DrinkgingWater_NTU.pkl"
...
export_graphviz(PrototypeTree, out_file=TreeGraphFileName, feature_names=['T', 'D', 'Q1'])
